...
function F(n13, r17 = {}, e8, a20, s13) {
  ...
  if (r17) {
    let d13 = false, p6 = [];
    for (let [c15, T10] of Object.entries(r17))
...
function U() {
  ...
  return (...e8) => {
    if (!e8.every((a20) => a20 == null))
      return n13.current = e8, r17;
  };
}
function $(...n13) {
  return n13.every((r17) => r17 == null) ? void 0 : (r17) => {
    for (let e8 of n13)
      e8 != null && (typeof e8 == "function" ? e8(r17) : e8.current = r17);
  };
}
function P2(...n13) {
  var a20;
  ...
  for (let s13 of n13)
    for (let t11 in s13)
      t11.startsWith("on") && typeof s13[t11] == "function" ? ((a20 = e8[t11]) != null || (e8[t11] = []), e8[t11].push(s13[t11])) : r17[t11] = s13[t11];
  if (r17.disabled || r17["aria-disabled"])
    for (let s13 in e8)
        ...
        if (!resetPlacement) {
          switch (fallbackStrategy) {
            case "bestFit": {
              ...
              const placement2 = (_overflowsData$map$so = overflowsData.map((d13) => [d13.placement, d13.overflows.filter((overflow2) => overflow2 > 0).reduce((acc, overflow2) => acc + overflow2, 0)]).sort((a20, b9) => a20[1] - b9[1])[0]) == null ? void 0 : _overflowsData$map$so[0];
              if (placement2) {
...
function getRectRelativeToOffsetParent(element, offsetParent, strategy) {
  ...
  const x10 = rect.left + scroll.scrollLeft - offsets.x;
...
function Ae3(e8, t11) {
  ...
  let B3 = l9();
  n(() => {
    if (f22 && B3 && v4 === "visible" && r17.current === null)
...
function Bt2(e8, i15) {
  ...
  n(() => {
    ...
    if (!d13)
      return n13.registerOption(r17, F6);
  }, [F6, r17, d13]);
  let h7 = o4((b9) => {
    var c15;
    if (a20)
    ...
    if (t11 !== null) {
      ...
      if (f22 !== null) {
        ...
        if (((p6 = d13.current) == null ? void 0 : p6.previousElementSibling) === c15.current || ((s13 = c15.current) == null ? void 0 : s13.previousElementSibling) === null)
          return { ...r17, activeItemIndex: f22 };
      }
    }
    ...
    if (P7) {
      ...
      switch (e8.key) {
        ...
        case o8.Escape:
          ...
          if (!r17.current || _8 != null && _8.activeElement && !r17.current.contains(_8.activeElement))
            return;
...
function yt3(o17, a20) {
  ...
  let Y4 = o4((t11) => {
    ...
    switch (t11.key) {
      case o8.Escape:
        if (r17.popoverState !== 0 || !n13.current || B3 != null && B3.activeElement && !n13.current.contains(B3.activeElement))
          return;
  ...
  (0, import_react102.useEffect)(() => {
    ...
    if (r17.__demoMode || !T10 || r17.popoverState !== 0 || !n13.current)
      return;
