...
function renderLatexInTextAsHTMLString(text, delimiters, strict, macros) {
  ...
  for (var i = 0; i < data.length; i++) {
    if (data[i].type === "text") {
      ...
      try {
        var rendered = katex_2(latex, { displayMode, macros });
...
function Latex$1(_a) {
  var children = _a.children, _b = _a.delimiters, delimiters = _b === void 0 ? defaultDelimiters : _b, _c = _a.strict, strict = _c === void 0 ? false : _c, macros = _a.macros;
  var renderedLatex = renderLatexInTextAsHTMLString(Array.isArray(children) ? children.join("") : children, delimiters, strict, macros);
  return (0, import_react.createElement)("span", { className: "__Latex__", dangerouslySetInnerHTML: { __html: renderedLatex } });
}
var index_es_default = Latex$1;
export {
  index_es_default as default
};
//# sourceMappingURL=react-latex-next.js.map
